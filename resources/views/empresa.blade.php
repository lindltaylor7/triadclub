    ...
    <body>
        ...
        <section class="area-login">
            ...
            <form method="POST" action="{{ route('reg2') }}" class="form-login">
                ...
                <input type="text" class="input-text" name="direccion" id="" placeholder="Dirección" value="{{old('direccion')}}" required autofocus>
                <input type="text" class="input-text" name="tlf" id="" placeholder="Teléfono" value="{{old('tlf')}}" required autofocus>
